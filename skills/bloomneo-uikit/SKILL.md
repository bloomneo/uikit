...
npx uikit generate feature <name>    # scaffold feature folder
npx uikit bundle                     # compile custom themes to CSS
npx uikit bundle --watch             # dev mode
npx uikit serve                      # dev server
npx uikit build                      # production build
npx uikit prerender                  # SPA → static HTML for SEO
npx uikit optimize                   # WebP / compress images
```
