...
declare namespace elegantTheme {
    let id: string;
    let name: string;
    ...
    namespace light {
        ...
        let contrast: string;
        let contrastForeground: string;
        let contrastMuted: string;
        let contrastMutedForeground: string;
        let contrastBorder: string;
        let border: string;
        let input: string;
        let ring: string;
        let chart1: string;
    ...
    namespace dark {
        ...
        let successForeground_1: string;
        export { successForeground_1 as successForeground };
        let warning_1: string;
        export { warning_1 as warning };
        let warningForeground_1: string;
        export { warningForeground_1 as warningForeground };
        let contrast_1: string;
        export { contrast_1 as contrast };
        let contrastForeground_1: string;
        export { contrastForeground_1 as contrastForeground };
        let contrastMuted_1: string;
        export { contrastMuted_1 as contrastMuted };
        let contrastMutedForeground_1: string;
        export { contrastMutedForeground_1 as contrastMutedForeground };
        let contrastBorder_1: string;
        export { contrastBorder_1 as contrastBorder };
        let border_1: string;
...
//# sourceMappingURL=elegant.d.ts.map